<template>
  <div class="header-product d-flex justify-content-between">
    <button type="button" @click="changeDialog" class="btn btn-outline-primary">Thêm sản phẩm</button>
    <div class="input-group custom-search">
      <input type="text" class="form-control" placeholder="Tìm kiếm" aria-label="Username" @keyup.enter="handleSearch"
             aria-describedby="basic-addon1" v-model="keyword">
    </div>
  </div>
  <div class="product-list">
    <tempalte v-for="product in products" :key="product.id">
  ...
  >
    <v-card>
      ...
      <v-card-actions>
        <v-spacer></v-spacer>
        <button @click="addProduct" type="button" class="btn btn-outline-primary">Thêm sản phẩm</button>
      </v-card-actions>
    </v-card>
  </v-dialog>
